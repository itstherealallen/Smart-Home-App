...
public class SecondFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.bed_room_fragment,null);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        timeSelectBedroom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showTimePickerDialog(getActivity(),  3, txtTimeBedroom, calendar);
            }
        });
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if("LVRMXXOPEN".equals(msg)){
                                ...
                                Toast.makeText(getActivity().getApplicationContext(), "Bedroom lights turned ON", Toast.LENGTH_SHORT).show();
                            }else{
                                bedroomDpxs.setImageResource(R.drawable.dp_dark);
                                Toast.makeText(getActivity().getApplicationContext(), "Bedroom lights turned OFF", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    outputStream.close();
