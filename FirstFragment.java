    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        timeSelectLiving.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showTimePickerDialog(getActivity(),  3, txtTimeLiving, calendar);
            }
        });
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if("LVRMXXOPEN".equals(msg)){
                                ...
                                Toast.makeText(getActivity().getApplicationContext(), "Living Room lights turned ON", Toast.LENGTH_SHORT).show();
                            }else{
                                livingDpxs.setImageResource(R.drawable.dp_dark);
                                Toast.makeText(getActivity().getApplicationContext(), "Living Room Lights turned OFF", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    outputStream.close();
