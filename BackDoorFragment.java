...
public class BackDoorFragment extends Fragment {
    ...
    private ImageView backDpxs;
    //打开和关闭客厅灯按钮
    private Button btnOpenBack;
    private Button btnCloseBack;
    //ip和端口
    private String ip;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.backdoor_fragment,null);
        mSharedPreference = this.getActivity().getSharedPreferences(SP_TEST, Context.MODE_PRIVATE);

        btnOpenBack = view.findViewById(R.id.btn_open_back);
        btnCloseBack = view.findViewById(R.id.btn_close_back);
        backDpxs = view.findViewById(R.id.back_dpxs);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //开灯
        btnOpenBack.setOnClickListener(new View.OnClickListener()  {
            @Override
        ...
        //关灯
        btnCloseBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if("LVRMXXOPEN".equals(msg)){
                                backDpxs.setImageResource(R.drawable.dp_light);
                                Toast.makeText(getActivity().getApplicationContext(), "Back Door Opened", Toast.LENGTH_SHORT).show();
                            }else{
                                backDpxs.setImageResource(R.drawable.dp_dark);
                                Toast.makeText(getActivity().getApplicationContext(), "Back Door Closed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    outputStream.close();
