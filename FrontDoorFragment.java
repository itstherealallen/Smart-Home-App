...
public class FrontDoorFragment extends Fragment {
    ...
    private ImageView frontDpxs;
    //打开和关闭客厅灯按钮
    private Button btnOpenFront;
    private Button btnCloseFront;
    //ip和端口
    private String ip;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.frontdoor_fragment,null);
        mSharedPreference = this.getActivity().getSharedPreferences(SP_TEST, Context.MODE_PRIVATE);

        btnOpenFront = view.findViewById(R.id.btn_open_front);
        btnCloseFront = view.findViewById(R.id.btn_close_front);
        frontDpxs = view.findViewById(R.id.front_dpxs);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //开灯
        btnOpenFront.setOnClickListener(new View.OnClickListener()  {
            @Override
        ...
        //关灯
        btnCloseFront.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if("LVRMXXOPEN".equals(msg)){
                                frontDpxs.setImageResource(R.drawable.dp_light);
                                Toast.makeText(getActivity().getApplicationContext(), "Front Door Opened", Toast.LENGTH_SHORT).show();
                            }else{
                                frontDpxs.setImageResource(R.drawable.dp_dark);
                                Toast.makeText(getActivity().getApplicationContext(), "Front Door Closed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    outputStream.close();
