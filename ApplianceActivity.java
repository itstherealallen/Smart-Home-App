...
public class ApplianceActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.appliance_fragment);
        ...
        //给组件添加 Fragment 列表
        viewPager.setAdapter( new ApplianceActivity.MyPageAdapter(getSupportFragmentManager(), mFragments) );

        //添加监听事件
        radioGroup4.setOnCheckedChangeListener(new ApplianceActivity.MyOnCheckedChangeListener());
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //创建Intent对象
                Intent intent = new Intent(ApplianceActivity.this, SetipActivity.class);
                //启动intent对应的Activity
    ...
    private List<Fragment> initFragment(){
        TvFragment f1 = new TvFragment();
        WashingFragment f2 = new WashingFragment();
        LampFragment f3 = new LampFragment();
