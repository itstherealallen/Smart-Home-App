...
public class HangersFragment extends Fragment {

    //xml存储ip和端口
    private SharedPreferences mSharedPreference;
    private static final String SP_TEST = "sp_test";
    private ImageView hangersDpxs;
    //打开和关闭客厅灯按钮
    private Button btnOpenHangers;
    private Button btnCloseHangers;
    //ip和端口
    private String ip;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.hangers_fragment,null);
        mSharedPreference = this.getActivity().getSharedPreferences(SP_TEST, Context.MODE_PRIVATE);

        btnOpenHangers = view.findViewById(R.id.btn_open_hangers);
        btnCloseHangers = view.findViewById(R.id.btn_close_hangers);
        hangersDpxs = view.findViewById(R.id.hangers_dpxs);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //开灯
        btnOpenHangers.setOnClickListener(new View.OnClickListener()  {
            @Override
        ...
        //关灯
        btnCloseHangers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if("LVRMXXOPEN".equals(msg)){
                                hangersDpxs.setImageResource(R.drawable.dp_light);
                                Toast.makeText(getActivity().getApplicationContext(), "Hanger hoisted", Toast.LENGTH_SHORT).show();
                            }else{
                                hangersDpxs.setImageResource(R.drawable.dp_dark);
                                Toast.makeText(getActivity().getApplicationContext(), "Hanger lowered", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    outputStream.close();
