...
public class SecurityActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //给组件添加 Fragment 列表
        viewPager.setAdapter( new SecurityActivity.MyPageAdapter(getSupportFragmentManager(), mFragments) );

        //添加监听事件
        radioGroup5.setOnCheckedChangeListener(new SecurityActivity.MyOnCheckedChangeListener());
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //创建Intent对象
                Intent intent = new Intent(SecurityActivity.this, SetipActivity.class);
                //启动intent对应的Activity
    ...
    private List<Fragment> initFragment(){
        FrontDoorFragment f1 = new FrontDoorFragment();
        BackDoorFragment f2 = new BackDoorFragment();
        GarageDoorFragment f3 = new GarageDoorFragment();
