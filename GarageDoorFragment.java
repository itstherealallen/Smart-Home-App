...
public class GarageDoorFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.garage_fragment,null);
        mSharedPreference = this.getActivity().getSharedPreferences(SP_TEST, Context.MODE_PRIVATE);

        btnOpenGarage = view.findViewById(R.id.btn_open_garage);
        btnCloseGarage = view.findViewById(R.id.btn_close_garage);
        garageDpxs = view.findViewById(R.id.garage_dpxs);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //开灯
        btnOpenGarage.setOnClickListener(new View.OnClickListener()  {
            @Override
        ...
        //关灯
        btnCloseGarage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if("LVRMXXOPEN".equals(msg)){
                                garageDpxs.setImageResource(R.drawable.dp_light);
                                Toast.makeText(getActivity().getApplicationContext(), "Garage Door Opened", Toast.LENGTH_SHORT).show();
                            }else{
                                garageDpxs.setImageResource(R.drawable.dp_dark);
                                Toast.makeText(getActivity().getApplicationContext(), "Garage Door Closed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    outputStream.close();
