...
public class WindowsFragment extends Fragment {
    ...
    private ImageView windowsDpxs;
    //打开和关闭客厅灯按钮
    private Button btnOpenWindows;
    private Button btnCloseWindows;
    //ip和端口
    private String ip;
    private Integer port;
    //定时按钮和显示组件
    private Button timeSelectWindows;
    private TextView txtTimeWindows;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.windows_fragment,null);
        mSharedPreference = this.getActivity().getSharedPreferences(SP_TEST, Context.MODE_PRIVATE);

        btnOpenWindows = view.findViewById(R.id.btn_open_windows);
        btnCloseWindows = view.findViewById(R.id.btn_close_windows);
        windowsDpxs = view.findViewById(R.id.windows_dpxs);

        timeSelectWindows = view.findViewById(R.id.time_select_windows);
        txtTimeWindows= view.findViewById(R.id.txt_time_windows);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        timeSelectWindows.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar calendar= Calendar.getInstance(Locale.CHINA);
                showTimePickerDialog(getActivity(),  3, txtTimeWindows, calendar);
            }
        });
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if("LVRMXXOPEN".equals(msg)){
                                windowsDpxs.setImageResource(R.drawable.dp_light);
                                Toast.makeText(getActivity().getApplicationContext(), "Windows opened", Toast.LENGTH_SHORT).show();
                            }else{
                                windowsDpxs.setImageResource(R.drawable.dp_dark);
                                Toast.makeText(getActivity().getApplicationContext(), "Windows opened", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
