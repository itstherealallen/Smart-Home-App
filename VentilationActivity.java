...
public class VentilationActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vent_fragment);
        ...
        //给组件添加 Fragment 列表
        viewPager.setAdapter( new VentilationActivity.MyPageAdapter(getSupportFragmentManager(), mFragments) );

        //添加监听事件
        radioGroup3.setOnCheckedChangeListener(new VentilationActivity.MyOnCheckedChangeListener());
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //创建Intent对象
                Intent intent = new Intent(VentilationActivity.this, SetipActivity.class);
                //启动intent对应的Activity
    ...
    private List<Fragment> initFragment(){
        AcFragment f1 = new AcFragment();
        WindowsFragment f2 = new WindowsFragment();
        CurtainsFragment f3 = new CurtainsFragment();
        HangersFragment f4 = new HangersFragment();
