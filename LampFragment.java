...
public class LampFragment extends Fragment {
    ...
    private ImageView lampDpxs;
    //打开和关闭客厅灯按钮
    private Button btnOpenLamp;
    private Button btnCloseLamp;
    //ip和端口
    private String ip;
    private Integer port;
    //定时按钮和显示组件
    private Button timeSelectLamp;
    private TextView txtTimeLamp;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnOpenLamp = view.findViewById(R.id.btn_open_lamp);
        btnCloseLamp = view.findViewById(R.id.btn_close_lamp);
        lampDpxs = view.findViewById(R.id.lamp_dpxs);

        timeSelectLamp = view.findViewById(R.id.time_select_lamp);
        txtTimeLamp= view.findViewById(R.id.txt_time_lamp);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        timeSelectLamp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar calendar= Calendar.getInstance(Locale.CHINA);
                showTimePickerDialog(getActivity(),  3, txtTimeLamp, calendar);
            }
        });
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if("LVRMXXOPEN".equals(msg)){
                                lampDpxs.setImageResource(R.drawable.dp_light);
                                Toast.makeText(getActivity().getApplicationContext(), "Bedside lamp turned ON", Toast.LENGTH_SHORT).show();
                            }else{
                                lampDpxs.setImageResource(R.drawable.dp_dark);
                                Toast.makeText(getActivity().getApplicationContext(), "Bedside lamp turned OFF", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    outputStream.close();
